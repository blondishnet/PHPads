...
function view()
{
	...
	if(!$data[12]) {
        ...
        echo "<tr><td nowrap=\"nowrap\"><span class=\"smalltext\"><a href=\"admin.php?action=edit&id=".urlencode($data[ PHPADS_ADELEMENT_ID ])."\" title=\"Edit Ad\">$data[11] (".$data[ PHPADS_ADELEMENT_ID ].")</a></span></td><td nowrap=\"nowrap\"><span class=\"smalltext\"><a href=\"$data[ PHPADS_ADELEMENT_LINK_URI ]\">$linkUrl</a></span></td><td nowrap=\"nowrap\"><span class=\"smalltext\"><a href=\"$data[10]\">$imageUrl</a></span></td><td><span class=\"smalltext\">$enabled</span></td><td><span class=\"smalltext\">$data[ PHPADS_ADELEMENT_WEIGHTING ]</span></td><td><span class=\"smalltext\">$starts</span></td><td><span class=\"smalltext\">$expires</span></td><td><span class=\"smalltext\">$remaining</span></td><td><span class=\"smalltext\">$data[ PHPADS_ADELEMENT_IMPRESSIONS ]</span></td><td><span class=\"smalltext\">$data[ PHPADS_ADELEMENT_CLICKTHRUS ]</span></td></tr>";
    }
    echo '</table></center>';
    foot();
}
